...
/// @brief Add a new player to the entries in the strcuture with 0 wins and 1 match
/// @param file_ds input data strcture
/// @param name name of player
/// @return a pointer to the entry that was just created
